...
Step 1: We scraped tweets with the keyword "megabus" during the period of January 1, 2015 through December 31, 2015 from the Twitter API using python package... 
...
We cleaned the data using dplyr and the tidytext package, available here: https://github.com/juliasilge/tidytext. 
